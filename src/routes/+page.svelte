...
<div id="control-bar-wrapper">
	<div id="control-bar">
		<button
			...
			title="Toggle Pulse"
		>
			<i class="fa-solid fa-music-slash off" />
			<i class="fa-solid fa-music on" />
		</button>
	</div>
</div>
...
<div id="logo">
	<img src="https://assets.codepen.io/1468070/Hyperplexed+Logo+-+White.png" alt="" />
</div>
